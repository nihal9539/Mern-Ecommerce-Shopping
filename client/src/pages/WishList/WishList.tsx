...
const WishList = () => {
    ...
    return (
      <>
        ...
        <div className=" h-screen w-full flex flex-col leading-10 justify-center items-center">
          ...
          <Link to={'/collection/all'} className="btn text-white hover:bg-black hover:scale-95 duration-500 bg-black">View Product</Link>
        </div>
      </>
    );
  }
  ...
  return (
    <div>
      <Navbar bgWhite={true} />
      <div className="p-12 px-36 max-lg:px-5 max-sm:px-2  pt-32 grid place-items-center items-start  grid-cols-4 max-lg:grid-cols-3 max-md:grid-col-2 max-sm:grid-cols-2">
        {wishlist?.map((data, i) => (
