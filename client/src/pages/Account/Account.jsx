...
const Account = () => {
  const {username} = useSelector(state=>state?.authReducer?.authData?.user)
  ...
  return (
    <div>
      ...
      <div className="h-screen w-full  flex flex-row gap-5 p-28 pb-10 px-48 max-lg:px-16 max-md:px-2">
        <div className="w-80  h-96 rounded-2xl sidebar relative   bg-white shadow-lg border-2 ">
          <div className=" h-20 rounded-xl w-full  shadow-lg justify-between items-center px-3.5 shadow-black/10 border-2 flex flex-row">
            <div>
        ...
        <div className=" w-full bg-white shadow-2xl border-2  rounded-lg overflow-scroll">
          <Outlet />
        </div>
      </div>
    </div>
